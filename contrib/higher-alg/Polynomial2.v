(* This is the same as Polynomial.v however with Mike's
   suggestion of changing the definition of Param.
 *)
...
Section Polynomial.
  ...
  Fixpoint Leaf {i : I} (w : Tree i) (j : I) : Type :=
    match w with
      | lf _ => i = j
      | nd _ (f; phi) => 
          exists (k:I) (p : Param P f), Leaf (phi k p) j
    end.
