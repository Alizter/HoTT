...
Section GenSpectrum.
  ...
  Proof.
    ...
    + intro. exact (vconcatR hrfl (loops_functor_idmap _)).
  Defined.
  ...
  Proof.
    ...
    + intro n. simpl. 
      exact (vconcatR (hconcat (smap_square g n) (smap_square f n)) (loops_functor_compose _ _)).
  Defined.
  ...
  Proof.
    ...
    + exact (pfib (f n)).
    + refine (move_left_bottom _). refine (vconcatR _ _).
