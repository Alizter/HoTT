...
Local Notation prod_type := Basics.Coq.Init.Datatypes.prod.
Local Notation fst_type := Basics.Coq.Init.Datatypes.fst.
Local Notation snd_type := Basics.Coq.Init.Datatypes.snd.
Local Notation pair_type := Basics.Coq.Init.Datatypes.pair.
